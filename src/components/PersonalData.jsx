...
const PersonalData = () => {
  return (
    <div data-aos="fade-up" data-aos-duration="1000" className="lg:w-[40%] bg-neutral-900 rounded-lg p-10 cursor-pointer border-blue-400 hover:border-2 hover:ease-in hover:duration-300">
